...
\hypersetup{unicode=true,
            pdftitle={A renda per capita dos municípios brasileiros},
...
\setlength{\droptitle}{-2em}
  \title{A renda per capita dos municípios brasileiros}
...
\subsection{Inrodução da Análise}\label{inroducao-da-analise}
