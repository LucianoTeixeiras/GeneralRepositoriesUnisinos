...
# Comando Formatado para R Markdown
dadosrs <- filter( select( subset.data.frame(dadosbrutos, UF == 43), ANO, UF, Município, RDPC, IDHM, ESPVIDA, GINI, pesourb ), Município %in% c("NOVO HAMBURGO", "SÃO LEOPOLDO", "SAPUCAIA DO SUL", "ESTEIO", "CANOAS", "PORTO ALEGRE", "GUAÍBA"))
